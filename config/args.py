...
parser.add_argument('--num_start',      type=int,   default=0,      help='Number of start audios for every adversary')
parser.add_argument('--num_end',       type=int,   default=10,     help='Number of stop audios for every adversary')
